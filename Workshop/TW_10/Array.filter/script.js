...
const products = [
  ...
  // const smartphones = products.filter((product)=>product.price < 50);
  // console.log(smartphones);

// const catag = new Set(products.map((cat)=>cat.category));
// const catag2 = [...new Set(products.map((cat)=>cat.category))];
// console.log(catag);
// console.log(catag2);
...
// const max = products.reduce((max1,max2)=> {
//     return max1.price > max2.price ? max1 : max2
// });
// console.log(max);
...
//    console.log(laptops);
// const laptopsUpdatedPrice = products
//   .filter((product) => product.category === 'laptops')
//   .map((laptop) => {
//     return { ...laptop, price: laptop.price + 10 };
//   });
// console.log(laptopsUpdatedPrice[0].price);
