...
if(u===tas && c===tas || u===makas && c===makas || u===kagit && c===kagit) win.innerHTML=ber;
if(u===tas && c===kagit || u===makas && c===tas || u===kagit && c===makas) win.innerHTML=kay;
if(u===kagit && c===tas || u===tas && c===makas || u===makas && c===kagit) win.innerHTML=kaz;
}
